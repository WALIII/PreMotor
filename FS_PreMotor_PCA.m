...
Aln{1};
AlignBound = 150:250;%Alignment Boundries ((Aln{1}-20):(Aln{1}+80))
...
x1a{group}(trial,:) = G_final{group}(range,5);
y1a{group}(trial,:) = G_final{group}(range,6);
z1a{group}(trial,:) = G_final{group}(range,7);
w1a{group}(trial,:) = G_final{group}(range,8);

hold on;

subplot(3,1,group)
hold on;
plot((1:length(x1a{group}(trial,:)))/25,x1a{group}(trial,:),'r');
plot((1:length(y1a{group}(trial,:)))/25,y1a{group}(trial,:),'g');
plot((1:length(z1a{group}(trial,:)))/25,z1a{group}(trial,:),'b');
