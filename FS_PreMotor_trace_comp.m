...
for cell =1:60%[16 23 25 41 4 10 11 14 15 19 26 36 37 48 49];% [16 25 33 36 37 41 56 59]%1:size(calcium,2); %[16 25 33 36 37 41 56 59] %[6 14 15 17 19 35 38 53]
G = calcium{cell};
 %16 23 25 41 4
